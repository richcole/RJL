...
void create_sets(Object* cxt, Object *pc) {
  ...
  set(cxt, begin_expr, "char_array", "true");
  set(cxt, begin_expr, "operator", "true");
  set(cxt, begin_expr, "number_literal", "true");
  set(cxt, begin_expr, "symbol_literal", "true");
  set(cxt, begin_expr, "group_open", "true");
};
